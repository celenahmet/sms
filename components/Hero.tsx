  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden hero-gradient">
      ...
      <div className="container mx-auto px-6 relative z-10 text-center">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-10 mb-16 text-brand-soft/90">
          <div className="flex items-center gap-3 group">
            <div className="p-2.5 rounded-xl glass border-brand-accent/20 group-hover:bg-brand-accent/10 transition-colors">
              <svg className="w-6 h-6 text-brand-accent" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <span className="font-heading uppercase tracking-[0.15em] text-base md:text-xl font-bold text-white/90">{displayDate}</span>
          </div>
          ...
          <div className="flex items-center gap-3 group">
            ...
            <span className="font-heading uppercase tracking-[0.15em] text-base md:text-xl font-bold text-white/90">{t('hero.location')}</span>
          </div>
        </div>
